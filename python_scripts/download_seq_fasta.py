...
if __name__ == "__main__":
    ...
    table.loc[table['gb_ncbi_seq_id'].isnull(),'gb_ncbi_seq_id'] = 'None'
    table['gb_ncbi_seq_id'] = table['gb_ncbi_seq_id'].apply(lambda row: eval(row) if type(row) is str else row)
